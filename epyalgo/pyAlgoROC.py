...
class pyAlgoROC(strategy.BacktestingStrategy):
    def __init__(self, feed, instrument, bBandsPeriod):
        ...
        self.__sma = roc.RateOfChange(feed[instrument].getCloseDataSeries(), 15)
...
def main(i, code):
    ...
    myStrategy = pyAlgoROC(dbfeed, code, bBandsPeriod=i)
    ms = eal()
